...
<div>
  ...
  <p>
    ...
    mode. It is a baseline for quality, clarity, and usability in complex
    scientific tools.
  </p>
  ...
  <p>
    ...
    We also use APCA (Advanced Perceptual Contrast Algorithm) to design for perceived readability. 
    Unlike WCAG contrast ratios, APCA accounts for font size, weight, and light/dark conditions. 
    
    WCAG defines minimum thresholds. APCA is used to ensure interfaces remain readable, comfortable, 
