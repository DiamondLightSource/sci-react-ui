...
<h3 style={{ fontFamily: "var(--ds-font-family-default)", fontSize: "var(--ds-font-size-900)" }}>Inter</h3>
...
<h3 style={{ fontFamily: "var(--ds-font-family-display)", fontSize: "var(--ds-font-size-900)" }}>Outfit</h3>
...
<h3 style={{ fontFamily: "var(--ds-font-family-mono)", fontSize: "var(--ds-font-size-900)" }}>IBM Plex Mono</h3>
