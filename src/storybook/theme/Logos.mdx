...
<div className="sb-container">
	<div className='sb-section-title'>
        ...
        <div style={{width:"660px", margin:"0 auto"}} >
            <ImageColourSchemeSwitch image={{"src":"static/media/src/public/generic/logo-light-surface.svg","alt":"A Logo",width:200}} style={{padding: "10px"}}/>
            <ImageColourSchemeSwitch image={{"src":"static/media/src/public/generic/logo-dark-surface.svg","alt":"A Logo",width:200}} style={{padding: "10px"}}/>
            <ImageColourSchemeSwitch image={{"src":"static/media/src/public/diamond/logo-dark-surface.svg","alt":"A Logo",width:200}} style={{padding: "10px"}}/>
        </div>
        ...
        <div style={{width:"200px", margin:"0 auto"}} >
            <ImageColourSchemeSwitch image={{"src":"static/media/src/public/generic/logo-light-surface.svg","alt":"A Logo",width:200}}/>
            <p>Example logo</p>
        </div>
